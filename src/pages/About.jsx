...
function About() {
    return (
        <div className="min-h-screen overflow-x-hidden flex items-center justify-center px-6 py-5 bg-[#020617] relative overflow-hidden pt-24">
          ...
          shadow-[0_0_35px_rgba(34,211,238,0.2)] text-center">
            ...
            text-cyan-300 drop-shadow-[0_0_10px_rgba(34,211,238,0.5)]">
                ...
                shadow-[0_0_20px_rgba(250,204,21,0.15)]">
                        ...
                        {/* RIGHT: Resume + Skills */}
                        <div className="md:w-1/2 mt-10 md:mt-0 flex flex-col gap-6">

                            {/* Resume Button */}
                            <a
                                href="/Adhnan-Resume.pdf"
                                download
                                className="self-center bg-cyan-400 text-black px-8 py-3 rounded-full
